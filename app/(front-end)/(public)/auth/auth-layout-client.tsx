...
function LayoutContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <div className="grid md:grid-cols-2 w-full min-h-none md:min-h-screen">
        ...
        {/* Right side - form */}
        <div className="relative flex flex-col items-center bg-transparent rounded-t-[50px] md:rounded-none md:bg-white md:py-8 min-h-[500px]">
          {/* Layer 3 */}
          <div className="absolute inset-0 -top-6 bg-gold-300 max-w-[535px] mx-auto rounded-t-[50px] md:hidden z-[1]" />
          {/* Layer 2 */}
          <div className="absolute inset-0 -top-3 bg-gold-500 max-w-[525px] mx-auto rounded-t-[50px] md:hidden z-[2]" />
          {/* Layer 1 */}
          <div className="relative w-full bg-white max-w-[515px] md:max-w-none rounded-t-[50px] md:rounded-none z-10 min-h-[500px] md:min-h-[800px] lg:min-h-[900px] pt-0 md:pt-8 md:pb-8">
            <div className="md:px-8 lg:px-12 xl:px-16 py-8 md:pt-32">
              {children}
            </div>
          </div>
        </div>
