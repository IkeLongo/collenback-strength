...
const navigation = [
  ...
  { name: 'My Clients', href: '/coach/clients', icon: UsersIcon },
  { name: 'Programs', href: '/coach/programs', icon: ClipboardIcon },
  { name: 'Workouts', href: '/coach/workouts', icon: DumbbellIcon },
  { name: 'Calendar', href: '/coach/calendar', icon: CalendarIcon },
  { name: 'Analytics', href: '/coach/analytics', icon: ChartBarIcon },
  { name: 'Profile', href: '/coach/profile', icon: UserIcon },
];
...
function CalendarIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5a2.25 2.25 0 002.25-2.25m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5a2.25 2.25 0 012.25 2.25v7.5m-9-6h.008v.008H12V15.75m-3.75 0h.008v.008H8.25V15.75m7.5 0h.008v.008H15.75V15.75M12 12.75h.008v.008H12V12.75m-3.75 0h.008v.008H8.25V12.75m7.5 0h.008v.008H15.75V12.75m-7.5 3h.008v.008H8.25V18.75m7.5 0h.008v.008H15.75V18.75M12 18.75h.008v.008H12V18.75m-3.75 0h.008v.008H8.25V18.75m7.5 0h.008v.008H15.75V18.75" />
    </svg>
  );
}
...
export function CoachSidebar({ mobile = false, sidebarOpen = false, setSidebarOpen }: CoachSidebarProps) {
