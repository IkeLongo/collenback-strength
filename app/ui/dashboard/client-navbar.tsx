          ...
          <div className="relative">
            ...
            >
              ...
              <span className="hidden lg:flex lg:items-center">
                ...
                <svg className="ml-2 h-5 w-5 text-grey-400" viewBox="0 0 20 20" fill="currentColor">
            ...
            {/* Dropdown menu */}
            {userMenuOpen && (
              <div className="absolute right-0 z-10 mt-2.5 w-32 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-grey-900/5 focus:outline-none">
                <a href="#" className="block px-3 py-1 text-sm leading-6 text-grey-900 hover:bg-grey-50">
                  Your profile
                </a>
                <button
                  onClick={() => logout()}
                  className="block w-full text-left px-3 py-1 text-sm leading-6 text-grey-900 hover:bg-grey-50"
                >
                  Sign out
                </button>
              </div>
