...
import { PhoneInput } from "@/app/components/ui/form/phone-input";
import { cn } from "@/lib/utils";
import { UserAvatar } from "@/app/components/ui/user/user-avatar";
  ...
  return (
    <div className="rounded-2xl bg-white p-6 shadow-input">
      ...
      <div className="flex items-center gap-4">
        <div className="h-16 w-16 rounded-full bg-grey-200 overflow-hidden flex items-center justify-center flex-shrink-0">
          <UserAvatar
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-2 text-xs text-grey-600">PNG/JPG/WEBP, under 2MB.</div>
        </div>
      </div>
