...
export default function Privacy() {
  return (
    <div className="flex flex-col items-center justify-start w-full h-auto">
      <main className="flex flex-col w-full h-full mx-4 overflow-x-hidden">
        <Suspense fallback={<ContactFormSkeleton />}>
          <div className="relative h-auto w-full max-w-[1020px] mx-auto bg-cover bg-top overflow-x-hidden top-24 lg:top-40 mb-24 px-4">
